...
export const UNIVERS = [
  {
    ...
    marques: [
      ...
      { name: 'Prescription Nature', img: '/photos/marques/astromax-new.webp' },
    ],
  },
  {
    num: '02',
    ...
    reverse: true,
    marques: [
      { name: 'A-Derma', img: '/photos/marques/aderma-new.webp' },
      ...
      { name: 'CeraVe', img: '/photos/marques/cerave-new.jpg' },
  ...
  },
  {
    ...
    marques: [
      ...
      { name: 'Fixodent', img: '/photos/marques/fixodent-new.avif' },
      { name: 'Fluocaril', img: '/photos/marques/fluocaril.jpg' },
      { name: 'GUM', img: '/photos/marques/gum-new.webp' },
